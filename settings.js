...
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '255 695 979 967' : process.env.OWNER_NUMBER,   
...
FOOTER: process.env.FOOTER=== undefined ? '> Created by Ellon': process.env.FOOTER,
...
COMMAND_TYPE: process.env.COMMAND_TYPE || 'space' ,
